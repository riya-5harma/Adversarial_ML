...
image_path = get_file('sample_image.jpg',
                      'https://cdn.britannica.com/70/192570-138-848FB7B3/penguin-species-places-Galapagos-Antarctica.jpg?w=800&h=450&c=crop')
...
for epss in epsilons:
    ...
    # Compute the loss sensitivity for the original image
    sensitivity_original = loss_sensitivity(classifier, preprocessed_image, original_preds)

    original_preds = classifier.predict(preprocessed_image)
    adversarial_preds = classifier.predict(adversarial_image)

    # Compute the loss sensitivity for the adversarial image
    sensitivity_adversarial = loss_sensitivity(classifier, adversarial_image, adversarial_preds)
    ...
    print("Loss Sensitivity for Original Image:", sensitivity_original)
    print("Loss Sensitivity for Adversarial Image:", sensitivity_adversarial)
