...
# Create a RobustnessVerificationTreeModelsCliqueMethod instance
robustness_verifier = RobustnessVerificationTreeModelsCliqueMethod(classifier=classifier)
...
for epss in epsilons:
    ...
    is_robust = robustness_verifier.verify(image=preprocessed_image, adversarial_image=adversarial_image)
    ...
    print("Robustness Verification:", is_robust)
    print("\nTrue Label:")
